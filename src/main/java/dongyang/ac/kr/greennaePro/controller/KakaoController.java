...
public class KakaoController {
    ...
    public @ResponseBody String getKakaoAuthUrl(
       ...
       log.info("getKakaoAuthUrl 들어옴");
        String reqUrl =
                "https://kauth.kakao.com/oauth/authorize"
                        + "?client_id=8f4ef318b069a37527ffa8dc55029e67"
                        + "&redirect_uri=http://localhost:8080/login/sociallogin"
                        + "&response_type=code";
    ...
    // 카카오 연동정보 조회
    @RequestMapping(value = "/login/sociallogin")
    public String oauthKakao(
        ...
        return "/login/signin"; //본인 원하는 경로 설정
    }
